            ...
            <div>
                ...
                <div class="row mt-3 bg-light mx-auto">
                    <div class=" col-sm" style="margin-left:35%"><span class="h2">Balance: <span
                                class="textnormh2">Rs.<span id="val"><% out.println(transactionDAO.totAcc(acc)); %></span></span></span>
                    </div>
                </div>
...
<script>
	...
	var cb = document.getElementById('val').innerHTML;
	document.getElementById('amnt1').max=parseInt(cb);
	document.getElementById('amnt2').max=parseInt(cb);
